...
function WatchlistCardTv({ trending }) {
      ...
      <NavLink to={`/details/tv/${trending.id}`} >
        <div >
          ...
          <div className='px-4 pt-1 w-full h-6'>
            <span className=' text-secondary line-clamp-1  text-sm font-pacifico'>{trending.title || trending.name}</span>
          </div>
        </div>
      </NavLink>
      <div>
...
export default WatchlistCardTv